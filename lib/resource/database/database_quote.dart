...
class DbQuote{
  ...
  factory DbQuote.fromMap(Map<String, dynamic> json) => new DbQuote(
    ...
    latestUpdate: json["latestUpdate"]=='null'?-1:json["latestUpdate"],
    latestVolume: json["latestVolume"]=='null'?-1:json["latestVolume"],
    ...
    marketCap: json["marketCap"]=='null'?-1:json["marketCap"],
